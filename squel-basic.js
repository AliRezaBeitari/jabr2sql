    ...
    */
    ...
    _createClass(_class13, [{
      ...
      */
      ...
      key: 'deleteField',
      value: function deleteField(_field) {
      ...
      key: 'deleteAllFields',
      value: function deleteAllFields() {
        this._fields = [];
      }
    }, {
      key: '_toParamString',
    ...
    */
    ...
    _createClass(_class28, [{
      ...
      value: function intersect(table) {
        var type = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'INTERSECT';
      ...
      value: function except(table) {
        var type = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'EXCEPT';
